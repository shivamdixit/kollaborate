...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_InitialDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 37, 23)
    ...
    "InitialDialog\0on_pushButton_clicked\0"
...
const QMetaObject InitialDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_InitialDialog.data,
      qt_meta_data_InitialDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_InitialDialog.stringdata))
        return static_cast<void*>(const_cast< InitialDialog*>(this));
